...
var dedicatedCopyrightNoteSources = /(\.js|\.go)$/;
...
var bannedTermsHelpString = 'Please review viewport service for helper ' +
    'methods or mark with `/*OK*/` or `/*REVIEW*/` and consult the Web Activities team. ' +
...
var requiredTerms = {
  'Copyright 20(17|18) The Web Activities Authors\\.':
...
function checkForbiddenAndRequiredTerms() {
  ...
  return gulp.src(srcGlobs)
    ...
    .on('end', function() {
      if (forbiddenFound) {
        util.log(util.colors.blue(
            'Please remove these usages or consult with the Web Activities team.'));
      }
