...
c.s=function(a,b){"connect"==a?this.b.sendCommand("start",this.h):"result"==a&&(a=b.code,L(this,a,"failed"==a?Error(b.data||""):b.data))};function M(a,b,d,e,f){this.a=a;this.$=b;this.aa=d;this.c=e;this.D=f}M.prototype.getMode=function(){return"redirect"};M.prototype.acceptResult=function(){var a=this,b=new h(this.$,this.aa,"redirect",this.c,this.D,!1);return new Promise(function(d){A(a.a,b,d)})};function N(a){this.version="1.0.0";this.a=a;this.X=a.location.hash;this.R={};this.S={}}N.prototype.openIframe=function(a,b,d){var e=new E(a,b,d);return e.connect().then(function(){return e})};N.prototype.open=function(a,b,d,e,f){var g=this,k=new F(this.a,a,b,d,e,f);k.open().then(function(){O(g,a,k)})};
...
e.location.hash&&e.history&&e.history.replaceState)try{e.history.replaceState(e.history.state,"",g)}catch(Q){}g=f.code;k=f.data;f=f.origin;l=e.document.referrer&&w(v(e.document.referrer));e=new M(e,g,k,f,f==l)}else e=null;else e=null;e&&(this.S[a]=e)}var J=e;J&&P(J,b)};function P(a,b){Promise.resolve().then(function(){b(a)})}function O(a,b,d){var e=a.R[b];e&&e.forEach(function(a){P(d,a)});a.S[b]=d};(function(a){function b(a){Promise.resolve().then(function(){a(f)})}var d=new N(a),e=new D(a),f={};Object.defineProperty(f,"version",{value:"1.0.0",configurable:!1});Object.defineProperty(f,"ports",{get:function(){return d}});Object.defineProperty(f,"hosts",{get:function(){return e}});var g=a.ACTIVITIES,k={};Object.defineProperty(k,"push",{get:function(){return b},configurable:!1});a.ACTIVITIES=k;g&&g.forEach(b)})(self);})();
