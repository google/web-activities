...
c.connect=function(a){var b=this;this.h=this.f=!1;var d;return this.U.connect(a).then(function(){b.ea=b.U.getRequestString()},function(a){d=a}).then(function(){b.b.connect(b.u.bind(b));b.b.sendConnectCommand();setTimeout(function(){b.g&&(d?b.g(Promise.reject(d)):b.g(b.U),b.g=null)},5E3);return b.B})};c.disconnect=function(){this.h=this.f=!1;this.b.disconnect();this.a.removeEventListener("unload",this.R);try{this.a.close()}catch(a){}};c.getRequestString=function(){K(this);return this.ea};
c.getMode=function(){return"popup"};c.getTargetOrigin=function(){K(this);return this.b.getTargetOrigin()};c.isTargetOriginVerified=function(){K(this);return!0};c.isSecureChannel=function(){return!0};c.accept=function(){K(this);this.h=!0};c.getArgs=function(){K(this);return this.i};c.ready=function(){L(this);this.b.sendCommand("ready")};c.setSizeContainer=function(a){this.s=a};c.onResizeComplete=function(a){this.m=a};c.resized=function(){var a=this;setTimeout(function(){return a.H()},50)};
c.isMessagingSupported=function(){return!0};c.message=function(a){L(this);this.b.customMessage(a)};c.onMessage=function(a){L(this);this.b.onCustomMessage(a)};c.messageChannel=function(a){L(this);return this.b.startChannel(a)};c.result=function(a){this.o("ok",a)};c.cancel=function(){this.o("canceled",null)};c.failed=function(a){this.o("failed",String(a))};c.ia=function(){if(!this.f)throw Error("not connected");};c.ha=function(){if(!this.h)throw Error("not accepted");};
c.o=function(a,b){"ok"==a?L(this):K(this);this.b.sendCommand("result",{code:a,data:b});this.a.removeEventListener("unload",this.R)};c.u=function(a,b){"start"==a?(this.i=b,this.f=!0,this.g(this),this.a.addEventListener("unload",this.R)):"close"==a&&this.disconnect()};c.H=function(){if(this.s){var a=this.s.scrollHeight,b=this.a.innerHeight;this.m&&this.m(b,a,b<a)}};c.oa=function(){this.b.sendCommand("check",{})};
function N(a){this.a=a;this.c=this.O=this.K=null;this.I=!1;this.i=null;this.h=this.f=!1;this.s=this.m=null}c=N.prototype;
...
b.K=d.requestId;b.i=d.args;if((f=d.returnUrl)&&-1!=t(f).protocol.indexOf("script"))throw Error('unsafe "'+f+'"');b.O=f;if(d.origin)b.c=d.origin,b.I=d.originVerified||!1;else{b.c=u(t(d.returnUrl));var q=b.a.document.referrer&&u(t(b.a.document.referrer));b.I=q==b.c}b.f=!0;return b})};c.disconnect=function(){this.h=this.f=!1};c.getRequestString=function(){K(this);return z({requestId:this.K,returnUrl:this.O,args:this.i,origin:this.c,originVerified:this.I})};c.getMode=function(){return"redirect"};
c.getTargetOrigin=function(){K(this);return this.c};c.isTargetOriginVerified=function(){K(this);return this.I};c.isSecureChannel=function(){return!1};c.accept=function(){K(this);this.h=!0};c.getArgs=function(){K(this);return this.i};c.ready=function(){L(this)};c.setSizeContainer=function(a){this.s=a};c.onResizeComplete=function(a){this.m=a};c.resized=function(){var a=this;setTimeout(function(){return a.H()},50)};c.isMessagingSupported=function(){return!1};c.message=function(){L(this)};
...
c.o=function(a,b){"ok"==a?L(this):K(this);var d=this.K,e;e=this.a;e=e.origin||u(e.location);a={requestId:d,origin:e,code:a,data:b};if(this.h)b=this.O;else if(b=this.O,!l.test(b))throw Error("must be http(s)");var f=b,g=f+(-1==f.indexOf("#")?"#":"&")+"__WA_RES__="+encodeURIComponent(JSON.stringify(a));a=g;this.a.location.replace?this.a.location.replace(a):this.a.location.assign(a)};c.H=function(){if(this.s){var a=this.s.scrollHeight,b=this.a.innerHeight;this.m&&this.m(b,a,b<a)}};function O(a){this.version="1.23";this.a=a}O.prototype.connectHost=function(a){return(this.a.top!=this.a?new J(this.a):this.a.opener&&this.a.opener!=this.a&&!this.a.opener.closed?new M(this.a):new N(this.a)).connect(a)};function P(a,b,d){var e=this;this.G=a;this.P=b;this.i=d||null;this.a=this.G.ownerDocument.defaultView;this.c=u(t(b));this.f=!1;this.g=null;this.B=new Promise(function(a){e.g=a});this.L=null;this.ka=new Promise(function(a){e.L=a});this.l=null;this.N=new Promise(function(a){e.l=a});this.M=this.T=null;this.b=new D(this.a,function(){return e.G.contentWindow},this.c,!0)}c=P.prototype;c.getMode=function(){return"iframe"};
c.connect=function(){var a;a=this.G;if("isConnected"in a)a=a.isConnected;else{var b=a.ownerDocument&&a.ownerDocument.documentElement;a=b&&b.contains(a)||!1}if(!a)throw Error("iframe must be in DOM");this.b.connect(this.u.bind(this));this.G.src=this.P;return this.B};c.disconnect=function(){this.f=!1;this.b.disconnect()};c.acceptResult=function(){return this.N};c.getTargetWin=function(){return this.G.contentWindow||null};c.message=function(a){this.b.customMessage(a)};c.onMessage=function(a){this.b.onCustomMessage(a)};
c.messageChannel=function(a){return this.b.askChannel(a)};c.whenReady=function(){return this.ka};c.onResizeRequest=function(a){var b=this;this.T=a;Promise.resolve().then(function(){null!=b.M&&a(b.M)})};c.resized=function(){this.f&&this.b.sendCommand("resized",{height:this.G.offsetHeight})};
c.u=function(a,b){"connect"==a?(this.f=!0,this.b.sendStartCommand(this.i),this.g()):"result"==a?this.l&&(a=b.code,b=new k(a,"failed"==a?Error(b.data||""):b.data,"iframe",this.b.getTargetOrigin(),!0,!0),A(this.a,b,this.l),this.l=null,this.b.sendCommand("close"),this.disconnect()):"ready"==a?this.L&&(this.L(),this.L=null):"resize"==a&&(this.M=b.height,this.T&&this.T(this.M))};function Q(a,b,d,e,f,g){var h=this,q=e&&("_blank"==e||"_top"==e||"_"!=e[0]);if(!q)throw Error('The only allowed targets are "_blank", "_top" and name targets');this.a=a;this.K=b;this.P=d;this.ca=e;this.i=f||null;this.D=g||{};this.g=null;this.B=new Promise(function(a){h.g=a});this.l=null;this.N=new Promise(function(a){h.l=a});this.b=this.C=this.A=null}c=Q.prototype;c.getMode=function(){return"_top"==this.ca?"redirect":"popup"};c.open=function(){return ba(this)};c.whenConnected=function(){return this.B};
c.disconnect=function(){this.C&&(this.a.clearInterval(this.C),this.C=null);this.b&&(this.b.disconnect(),this.b=null);if(this.A){try{this.A.close()}catch(a){}this.A=null}this.l=null};c.getTargetWin=function(){return this.A};c.acceptResult=function(){return this.N};c.message=function(a){this.b.customMessage(a)};c.onMessage=function(a){this.b.onCustomMessage(a)};c.messageChannel=function(a){return this.b.askChannel(a)};
function ba(a){var b=ca(a),d=a.P;if(!a.D.skipRequestInUrl)var e=a.D.returnUrl||v(a.a.location.href),e=z({requestId:a.K,returnUrl:e,args:a.i}),d=d+(-1==d.indexOf("#")?"#":"&")+encodeURIComponent("__WA__")+"="+encodeURIComponent(e);var f,g=a.ca;"_top"!=g&&B(a.a)&&(g="_top");try{f=a.a.open(d,g,b)}catch(h){}if(!f&&"_top"!=g&&!a.D.disableRedirectFallback){g="_top";try{f=a.a.open(d,g)}catch(h){}}f?(a.A=f,"_top"!=g&&da(a)):R(a,Error("failed to open window"));return a.N.catch(function(){})}
...
function T(a,b,d){if(a.l){var e=a.b.isConnected();b=new k(b,d,"popup",e?a.b.getTargetOrigin():u(t(a.P)),e,e);A(a.a,b,a.l);a.l=null}a.b&&a.b.sendCommand("close");a.disconnect()}c.u=function(a,b){var d=this;"connect"==a?(this.b.sendStartCommand(this.i),this.g()):"result"==a?(a=b.code,T(this,a,"failed"==a?Error(b.data||""):b.data)):"check"==a&&this.a.setTimeout(function(){return S(d)},200)};function U(a,b,d,e,f){this.a=a;this.fa=b;this.ga=d;this.c=e;this.I=f}U.prototype.getMode=function(){return"redirect"};
U.prototype.acceptResult=function(){var a=this,b=new k(this.fa,this.ga,"redirect",this.c,this.I,!1);return new Promise(function(d){A(a.a,b,d)})};function X(a){var b=this;this.version="1.23";this.a=a;this.aa=a.location.hash;this.V={};this.W={};this.da=null;this.la=new Promise(function(a){b.da=a})}c=X.prototype;c.openIframe=function(a,b,d){var e=new P(a,b,d);return e.connect().then(function(){return e})};c.open=function(a,b,d,e,f){return{targetWin:Y(this,a,b,d,e,f).getTargetWin()}};c.openWithMessaging=function(a,b,d,e,f){var g=Y(this,a,b,d,e,f);return g.whenConnected().then(function(){return g})};
...
function Z(a,b){Promise.resolve().then(function(){b(a)})}function ga(a,b,d){var e=a.V[b];e&&e.forEach(function(a){Z(d,a)});a.W[b]=d};(function(a){function b(a){Promise.resolve().then(function(){a(f)})}var d=new X(a),e=new O(a),f={};Object.defineProperty(f,"version",{value:"1.23",configurable:!1});Object.defineProperty(f,"ports",{get:function(){return d}});Object.defineProperty(f,"hosts",{get:function(){return e}});var g=a.ACTIVITIES,h={};Object.defineProperty(h,"push",{get:function(){return b},configurable:!1});a.ACTIVITIES=h;g&&g.forEach(b)})(self);})();
