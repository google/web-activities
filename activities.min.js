...
function z(a){var b={requestId:a.requestId,returnUrl:a.returnUrl,args:a.args};void 0!==a.origin&&(b.origin=a.origin);void 0!==a.originVerified&&(b.originVerified=a.originVerified);return JSON.stringify(b)}function A(a,b,d){if(b.ok)d(b);else{var e;(e=b.error)||("DOMException"in a?a=new DOMException("AbortError","AbortError"):(a=Error("AbortError"),a.name="AbortError",a.code=20),e=a);a=e;a.activityResult=b;d(Promise.reject(a))}};function B(a){var b=this;if(!a.opener||a.opener==a)throw Error("No window.opener");this.a=a;this.w=a.opener;this.b=new m(this.a,this.w,null);this.h=null;this.f=!1;this.i=null;this.F=new Promise(function(a){b.i=a});this.g=!1;this.o=this.l=null;this.P=new C(this.a)}c=B.prototype;c.connect=function(a){var b=this;this.g=this.f=!1;return this.P.connect(a).then(function(){b.b.connect(b.s.bind(b));b.b.sendCommand("connect");setTimeout(function(){b.i&&(b.i(b.P),b.i=null)},5E3);return b.F})};
c.disconnect=function(){this.g=this.f=!1;this.b.disconnect();try{this.a.close()}catch(a){}};c.getRequestString=function(){r(this);return this.P.getRequestString()};c.getMode=function(){return"popup"};c.getTargetOrigin=function(){r(this);return this.b.getTargetOrigin()};c.isTargetOriginVerified=function(){r(this);return!0};c.isSecureChannel=function(){return!0};c.accept=function(){r(this);this.g=!0};c.getArgs=function(){r(this);return this.h};c.ready=function(){t(this);this.b.sendCommand("ready")};
...
function G(a){var b=H(a),d=a.U;if(!a.u||!a.u.skipRequestInUrl)var e=a.u&&a.u.returnUrl||x(a.a.location.href),e=z({requestId:a.I,returnUrl:e,args:a.h}),d=d+(-1==d.indexOf("#")?"#":"&")+encodeURIComponent("__WA__")+"="+encodeURIComponent(e);var f,g=a.Z;try{f=a.a.open(d,g,b)}catch(k){}if(!f&&"_top"!=g){g="_top";try{f=a.a.open(d,g)}catch(k){}}f?(a.v=f,"_top"!=g&&I(a)):K(a,Error("failed to open window"));return a.L.catch(function(){})}
...
function I(a){a.A=a.a.setInterval(function(){if(!a.v||a.v.closed)a.a.clearInterval(a.A),a.A=null,a.a.setTimeout(function(){try{L(a,"canceled",null)}catch(b){K(a,b)}},3E3)},500);a.b=new m(a.a,a.v,null);a.b.connect(a.s.bind(a))}function K(a,b){a.j&&a.j(Promise.reject(b));a.disconnect()}function L(a,b,d){a.j&&(b=new h(b,d,"popup",a.b.getTargetOrigin(),!0,!0),A(a.a,b,a.j),a.j=null);a.b&&a.b.sendCommand("close");a.disconnect()}
c.s=function(a,b){"connect"==a?this.b.sendCommand("start",this.h):"result"==a&&(a=b.code,L(this,a,"failed"==a?Error(b.data||""):b.data))};function M(a,b,d,e,f){this.a=a;this.$=b;this.aa=d;this.c=e;this.D=f}M.prototype.getMode=function(){return"redirect"};M.prototype.acceptResult=function(){var a=this,b=new h(this.$,this.aa,"redirect",this.c,this.D,!1);return new Promise(function(d){A(a.a,b,d)})};function N(a){this.version="1.1.0";this.a=a;this.X=a.location.hash;this.R={};this.S={}}N.prototype.openIframe=function(a,b,d){var e=new E(a,b,d);return e.connect().then(function(){return e})};N.prototype.open=function(a,b,d,e,f){var g=this,k=new F(this.a,a,b,d,e,f);k.open().then(function(){O(g,a,k)})};
N.prototype.onResult=function(a,b){var d=this.R[a];d||(d=[],this.R[a]=d);d.push(b);var e=this.S[a];if(!e&&this.X){var e=this.a,f=y(this.X).__WA_RES__;if(f)if((f=JSON.parse(decodeURIComponent(f)))&&f.requestId==a){var g=e.location.hash;if(g){var k=encodeURIComponent("__WA_RES__")+"=",l=-1;do if(l=g.indexOf(k,l),-1!=l){var n=0<l?g.substring(l-1,l):"";""==n||"?"==n||"#"==n||"&"==n?(n=g.indexOf("&",l+1),-1==n&&(n=g.length),g=g.substring(0,l)+g.substring(n+1)):l++}while(-1!=l&&l<g.length)}g=g||"";if(g!=
e.location.hash&&e.history&&e.history.replaceState)try{e.history.replaceState(e.history.state,"",g)}catch(Q){}g=f.code;k=f.data;f=f.origin;l=e.document.referrer&&w(v(e.document.referrer));e=new M(e,g,k,f,f==l)}else e=null;else e=null;e&&(this.S[a]=e)}var J=e;J&&P(J,b)};function P(a,b){Promise.resolve().then(function(){b(a)})}function O(a,b,d){var e=a.R[b];e&&e.forEach(function(a){P(d,a)});a.S[b]=d};(function(a){function b(a){Promise.resolve().then(function(){a(f)})}var d=new N(a),e=new D(a),f={};Object.defineProperty(f,"version",{value:"1.1.0",configurable:!1});Object.defineProperty(f,"ports",{get:function(){return d}});Object.defineProperty(f,"hosts",{get:function(){return e}});var g=a.ACTIVITIES,k={};Object.defineProperty(k,"push",{get:function(){return b},configurable:!1});a.ACTIVITIES=k;g&&g.forEach(b)})(self);})();
