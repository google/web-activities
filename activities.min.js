...
e.location.hash&&e.history&&e.history.replaceState)try{e.history.replaceState(e.history.state,"",g)}catch(R){}g=f.code;k=f.data;f=f.origin;l=e.document.referrer&&x(w(e.document.referrer));e=new N(e,g,k,f,f==l)}else e=null;else e=null;e&&(this.U[a]=e)}var K=e;K&&Q(K,b)};function Q(a,b){Promise.resolve().then(function(){b(a)})}function P(a,b,d){var e=a.T[b];e&&e.forEach(function(a){Q(d,a)});a.U[b]=d};(function(a){function b(a){Promise.resolve().then(function(){a(f)})}var d=new O(a),e=new E(a),f={};Object.defineProperty(f,"version",{value:"1.3.0",configurable:!1});Object.defineProperty(f,"ports",{get:function(){return d}});Object.defineProperty(f,"hosts",{get:function(){return e}});var g=a.ACTIVITIES,k={};Object.defineProperty(k,"push",{get:function(){return b},configurable:!1});a.ACTIVITIES=k;g&&g.forEach(b)})(self);})();
