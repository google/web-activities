...
function H(a){var b=I(a),d=a.O;if(!a.u||!a.u.skipRequestInUrl)var e=a.u&&a.u.returnUrl||y(a.a.location.href),e=A({requestId:a.J,returnUrl:e,args:a.h}),d=d+(-1==d.indexOf("#")?"#":"&")+encodeURIComponent("__WA__")+"="+encodeURIComponent(e);var f,g=a.aa;try{f=a.a.open(d,g,b)}catch(k){}if(!f&&"_top"!=g){g="_top";try{f=a.a.open(d,g)}catch(k){}}f?(a.w=f,"_top"!=g&&J(a)):K(a,Error("failed to open window"));return a.M.catch(function(){})}
function I(a){var b=a.a.screen,d=Math.floor(Math.min(600,.9*b.width)),e=Math.floor(Math.min(600,.9*b.height));a.u&&(a.u.width&&(d=Math.min(a.u.width,b.width)),a.u.height&&(e=Math.min(a.u.height,b.height)));a={height:e,width:d,left:Math.floor((b.width-d)/2),top:Math.floor((b.height-e)/2),resizable:"yes",scrollbars:"yes"};var b="",f;for(f in a)b&&(b+=","),b+=f+"="+a[f];return b}function J(a){a.B=a.a.setInterval(function(){M(a,!0)},500);a.b=new m(a.a,a.w,null);a.b.connect(a.s.bind(a))}
function M(a,b){if(!a.w||a.w.closed)a.a.clearInterval(a.B),a.B=null,a.a.setTimeout(function(){try{N(a,"canceled",null)}catch(d){K(a,d)}},b?3E3:0)}function K(a,b){a.j&&a.j(Promise.reject(b));a.disconnect()}function N(a,b,d){if(a.j){var e=a.b.isConnected();b=new h(b,d,"popup",e?a.b.getTargetOrigin():x(w(a.O)),e,e);B(a.a,b,a.j);a.j=null}a.b&&a.b.sendCommand("close");a.disconnect()}
c.s=function(a,b){var d=this;"connect"==a?this.b.sendCommand("start",this.h):"result"==a?(a=b.code,N(this,a,"failed"==a?Error(b.data||""):b.data)):"check"==a&&this.a.setTimeout(function(){return M(d)},200)};function O(a,b,d,e,f){this.a=a;this.ba=b;this.ca=d;this.c=e;this.F=f}O.prototype.getMode=function(){return"redirect"};O.prototype.acceptResult=function(){var a=this,b=new h(this.ba,this.ca,"redirect",this.c,this.F,!1);return new Promise(function(d){B(a.a,b,d)})};function P(a){this.version="1.5.0";this.a=a;this.Z=a.location.hash;this.U={};this.V={}}P.prototype.openIframe=function(a,b,d){var e=new F(a,b,d);return e.connect().then(function(){return e})};P.prototype.open=function(a,b,d,e,f){var g=this,k=new G(this.a,a,b,d,e,f);k.open().then(function(){Q(g,a,k)});return{targetWin:k.getTargetWin()}};
...
e.location.hash&&e.history&&e.history.replaceState)try{e.history.replaceState(e.history.state,"",g)}catch(S){}g=f.code;k=f.data;f=f.origin;l=e.document.referrer&&x(w(e.document.referrer));e=new O(e,g,k,f,f==l)}else e=null;else e=null;e&&(this.V[a]=e)}var L=e;L&&R(L,b)};function R(a,b){Promise.resolve().then(function(){b(a)})}function Q(a,b,d){var e=a.U[b];e&&e.forEach(function(a){R(d,a)});a.V[b]=d};(function(a){function b(a){Promise.resolve().then(function(){a(f)})}var d=new P(a),e=new E(a),f={};Object.defineProperty(f,"version",{value:"1.5.0",configurable:!1});Object.defineProperty(f,"ports",{get:function(){return d}});Object.defineProperty(f,"hosts",{get:function(){return e}});var g=a.ACTIVITIES,k={};Object.defineProperty(k,"push",{get:function(){return b},configurable:!1});a.ACTIVITIES=k;g&&g.forEach(b)})(self);})();
